package com.fireblaze.truly_enchanting.client.screen;
...
import com.fireblaze.truly_enchanting.client.screen.utils.BlocklistScreen;
import com.fireblaze.truly_enchanting.client.screen.utils.ScreenController;
import com.fireblaze.truly_enchanting.client.screen.utils.ScreenSide;
...
public class MonolithScreen extends AbstractContainerScreen<MonolithMenu> {
    ...
    protected void renderBg(GuiGraphics graphics, float partialTicks, int mouseX, int mouseY) {
        ...
        for (Enchantment ench : rune.enchantments) {
            ...
            // Maximaler MagicCost
            int maxCost = com.fireblaze.truly_enchanting.util.MagicCostCalculator.calculateMagicRequirement(ench, ench.getMaxLevel());
            ...
            for (int lvl = 1; lvl <= ench.getMaxLevel(); lvl++) {
                int required = com.fireblaze.truly_enchanting.util.MagicCostCalculator.calculateMagicRequirement(ench, lvl);
    ...
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(TrulyEnchanting.MODID, "textures/gui/monolith_gui.png");
